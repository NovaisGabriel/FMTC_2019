...
{t1 <- proc.time()
yhat <- okrig(Z, y, X, function(h) {(gauVM(h, res[1], res[2], res[3]))})
proc.time()-t1}
calMeasure(greek$fmv/1000, yhat)

png("gauqq.png", width=8, height=4, units="in", res=300)
par(mfrow=c(1,2), mar=c(4,4,1,1))
plot(greek$fmv/1000, yhat, xlab="FMV(MC)", ylab="FMV(OK)")
abline(0,1)
qqplot(greek$fmv/1000, yhat, xlab="FMV(MC)", ylab="FMV(OK)")
abline(0,1)
dev.off()
...
# ordinary kriging based on hkmeans
...
png("gauhkmean.png", width=8, height=4, units="in", res=300)
par(mfrow=c(1,2), mar=c(4,4,1,1))
plot(greek$fmv/1000, yhat, xlab="FMV(MC)", ylab="FMV(OK)")
abline(0,1)
qqplot(greek$fmv/1000, yhat, xlab="FMV(MC)", ylab="FMV(OK)")
